            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title"><b>{{ trans('admin.payments') }}</b></h4>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'action', orderable: false,
                    render: function(data, type, row, meta) {
                        ...
                        return (
                            '<span>' +
                                '@if(auth()->user()->can('update_payments'))' +
                                    '<a id="'+ row.id +'" name="edit" class="item-edit edit mr-1" data-toggle="modal" data-target="#paymentModal" title="{{ trans("admin.edit") }}">' +
            ...
            buttons: [
                ...
                { text: '<i data-feather="trash-2"></i> {{ trans("admin.trash") }}',
                  className: '@if (auth()->user()->can("trash_payments")) btn dtbtn btn-sm btn-danger multi_delete @else btn dtbtn btn-sm btn-danger disabled @endif',
                ...
                { text: '<i data-feather="printer"></i> {{ trans("admin.print") }}',
                  className: '@if (auth()->user()->can("print_payments")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                ...
                { text: '<i data-feather="plus"></i> {{ trans("admin.create_payment") }}',
        ...
        $(document).on('click', '#create_payment', function(){
            $('.modal-title').text("{{ trans('admin.create_payment') }}");
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.ajax({
                ...
                success: function(html){
                    ...
                    $('.modal-title').text("{{ trans('admin.edit_payment') }}");
