<!-- Notification Modal -->
<div class="modal modal-slide-in fade" id="notificationModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog sidebar-sm">
        <form method="POST" class="add-new-record modal-content pt-0" id="notificationForm" enctype="multipart/form-data">
            @csrf
