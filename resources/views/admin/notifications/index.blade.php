...
@section('title') {{ trans('admin.notifications') }} @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title"><b>{{ trans('admin.notifications') }}</b></h4>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'action', orderable: false,
                    render: function(data, type, row, meta) {
                        ...
                        return (
                            '<span>' +
                                '@if(auth()->user()->can('update_notifications'))' +
                                    '<a id="'+ row.id +'" name="edit" class="item-edit edit mr-1" data-toggle="modal" data-target="#notificationModal" title="{{ trans("admin.edit") }}">' +
            ...
            buttons: [
                ...
                { text: '<i data-feather="trash-2"></i> {{ trans("admin.trash") }}',
                  className: '@if (auth()->user()->can("trash_notifications")) btn dtbtn btn-sm btn-danger multi_delete @else btn dtbtn btn-sm btn-danger disabled @endif',
                ...
                { text: '<i data-feather="printer"></i> {{ trans("admin.print") }}',
                  className: '@if (auth()->user()->can("print_notifications")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                ...
                { text: '<i data-feather="plus"></i> {{ trans("admin.create_notification") }}',
                  className: '@if (auth()->user()->can("create_notifications")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                  attr: {
                    'title': '{{ trans("admin.create_notification") }}',
                    'data-toggle': 'modal',
        ...
        // Open Modal
        $(document).on('click', '#create_notification', function(){
            $('.modal-title').text("{{ trans('admin.create_notification') }}");
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.ajax({
                ...
                success: function(html){
                    ...
                    $('.modal-title').text("{{ trans('admin.edit_notification') }}");
