<!-- Appointment Modal -->
<div class="modal modal-slide-in fade" id="appointmentModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog sidebar-sm">
        <form method="POST" class="add-new-record modal-content pt-0" id="appointmentForm"
