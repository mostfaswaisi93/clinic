...
@section('title') {{ trans('admin.edit_appointment') }} @endsection
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ trans('admin.edit_appointment') }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.appointments.index') }}">{{ trans('admin.appointments') }}</a>
                        </li>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            ...
                            {{ trans('admin.edit_appointment') }} - {{ $appointment->name }}
                        </h4>
                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mt-1">
                                        <div class="form-group">
                                            ...
                                            <input id="name[{{ $locale }}]" type="text" name="name[{{ $locale }}]"
                                                class="form-control"
                                                value="{{ old('name.' . $locale, $appointment->getTranslation('name', $locale)) }}"
