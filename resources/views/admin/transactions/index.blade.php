...
@section('title') {{ trans('admin.transactions') }} @endsection
...
<div class="content-body">
    <section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title"><b>{{ trans('admin.transactions') }}</b></h4>
                    </div>
        ...
        @include('admin.transactions.modal')
    </section>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'action', orderable: false,
                    render: function(data, type, row, meta) {
                        ...
                        return (
                            '<span>' +
                                '@if(auth()->user()->can('update_transactions'))' +
                                    '<a id="'+ row.id +'" name="edit" class="item-edit edit mr-1" data-toggle="modal" data-target="#transactionModal" title="{{ trans("admin.edit") }}">' +
            ...
            buttons: [
                ...
                { text: '<i data-feather="trash-2"></i> {{ trans("admin.trash") }}',
                  className: '@if (auth()->user()->can("trash_transactions")) btn dtbtn btn-sm btn-danger multi_delete @else btn dtbtn btn-sm btn-danger disabled @endif',
                ...
                { text: '<i data-feather="printer"></i> {{ trans("admin.print") }}',
                  className: '@if (auth()->user()->can("print_transactions")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                ...
                { text: '<i data-feather="plus"></i> {{ trans("admin.create_transaction") }}',
                  className: '@if (auth()->user()->can("create_transactions")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                  attr: {
                    'title': '{{ trans("admin.create_transaction") }}',
                    'data-toggle': 'modal',
        ...
        $(document).on('click', '#create_transaction', function(){
            $('.modal-title').text("{{ trans('admin.create_transaction') }}");
        ...
        $(document).on('click', '.edit', function(){
            ...
            $('#form_result').html('');
            $.ajax({
                url: "/admin/transactions/"+ id +"/edit",
                dataType: "json",
                success: function(html){
                    ...
                    $('.modal-title').text("{{ trans('admin.edit_transaction') }}");
