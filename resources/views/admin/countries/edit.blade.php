                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input id="mob" type="text" name="mob" class="form-control"
                                                    value="{{ $country->mob }}" placeholder="{{ trans('admin.mob') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input id="code" type="text" name="code" class="form-control"
                                                    value="{{ $country->code }}" placeholder="{{ trans('admin.code') }}">
                                            </div>
                                        </div>
                                    </div>
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input id="currency" type="text" name="currency[{{ $locale }}]"
                                                    class="form-control"
                                                    value="{{ old('currency.' . $locale, $country->getTranslation('currency', $locale)) }}"
