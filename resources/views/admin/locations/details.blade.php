...
@section('title') {{ trans('admin.create_location') }} @endsection
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ trans('admin.create_location') }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.locations.index') }}">{{ trans('admin.locations') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ trans('admin.create_location') }}</li>
                    </ol>
                </div>
            </div>
        </div>
