                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <div class="text-right">
                            ...
                            <button type="button" name="create_location" id="create_location"
                                class="btn btn-sm btn-primary" data-toggle="modal" data-target="#locationModal">
                                <i class="mr-25" data-feather="plus"></i>
                                {{ trans('admin.create_location') }}</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
                ...
                { data: 'action', orderable: false,
                    render: function(data, type, row, meta) {
                        return (
                            ...
                            '</div>' +
                            '</div>' +
                            '<a id="'+ row.id +'" name="edit" class="item-edit edit" data-toggle="modal" data-target="#locationModal" title="{{ trans("admin.edit") }}">' +
            ...
            buttons: [{
                ...
                {
                    text: feather.icons['plus'].toSvg({ class: 'mr-50 font-small-4' }) + '{{ trans("admin.create_location") }}',
    ...
    $(document).on('change', '#status', function(e) {
        var status_location = $(this).find("option:selected").val();
        ...
        $.ajax({
            url: "locations/updateStatus/"+location_id+"?enabled="+status_location,
            headers: {
