        ...
        $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'action', orderable: false,
                    render: function(data, type, row, meta) {
                        // Action Buttons
                        return (
                            '<span>@if(auth()->user()->can('update_constants'))' +
                            ...
                            '</a>' +
                            '@endif </span>' +
                            '<span>@if(auth()->user()->can('delete_constants'))' +
            ...
            buttons: [
                ...
                { text: '<i data-feather="trash-2"></i> {{ trans("admin.trash") }}',
                  className: '@if (auth()->user()->can("multi_delete_constants")) btn dtbtn btn-sm btn-danger multi_delete @else btn dtbtn btn-sm btn-danger disabled @endif',
