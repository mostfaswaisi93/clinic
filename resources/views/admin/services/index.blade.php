    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            "columnDefs": [ 
            {
                ...
                render: function(data, type, row, meta) {
                    return (
                        '<div class="custom-control custom-checkbox"> <input class="custom-control-input dt-checkboxes item_checkbox" name="item[]" data-id="'+ row.id +'" type="checkbox" value="'+ row.id +'" id="'+ row.id +'" />' +
            ...
            buttons: [
                ...
                { text: '<i data-feather="trash-2"></i> {{ trans("admin.trash") }}',
                  className: '@if (auth()->user()->can("del_all_services")) btn dtbtn btn-sm btn-danger multi_delete @else btn dtbtn btn-sm btn-danger disabled @endif',
